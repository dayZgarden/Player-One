...
export default function GameForGenre({ result }) {
  ...
  ease-in transform sm:hover:scale-105 hover:z-50 lg:w-1/3 xl:w-1/4 border-t-2 border-b-2
   border-t-cyan-900 border-b-blue-900 rounded-lg group shadow-xl z-1 justify-center " to={{
    ...
    >
      <img loading="lazy"
      className="rounded-lg max-w-[360px] max-h-full h-[360px] object-cover " src= {result.background_image}
      />
